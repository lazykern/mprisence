...
## [1.4.6](https://github.com/lazykern/mprisence/compare/v1.4.5...v1.4.6)

* Config
  * Removed deprecated `clear_on_pause` setting (Discord activity is now always cleared on pause)
